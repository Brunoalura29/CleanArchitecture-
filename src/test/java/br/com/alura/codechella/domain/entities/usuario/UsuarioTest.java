...
public class UsuarioTest {
    ...
    public void NaoDeveCadastrarUsuarioComCpfNoFormatoInvalido() {
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new Usuario("123.456.789-99", "Jaque", LocalDate.parse("1990-09-08"), "email@email.com"));
    }

    @Test
    public void DeveCriarUsuarioComAFabrica() {
        FabricaDeUsuario fabrica = new FabricaDeUsuario();
        Usuario usuario = fabrica.comNomeCpfNascimento("Emily", "654.789.321-11", LocalDate.parse("2000-10-20"));
